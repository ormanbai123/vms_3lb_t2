    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'Admin_stuff'), (2, 'Driver'), (3, 'Maintenance_person'), (4, 'Fueling_person')], default=1, max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('driver_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms_app.driver')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('driver_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms_app.driver')),
                ('task_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vms_app.task')),
            ],
        ),
    ]
